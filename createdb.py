...
if round:
    ...
    session.execute(text("INSERT INTO users (id, name, alias, passwd, active, access, email, phone, pubphone, sponsor) SELECT id, name, alias, passwd, active, access, email, phone, pubphone, sponsor FROM %s.users;" % (round,)))
