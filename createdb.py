...
if round:
    ...
    session.execute(text("INSERT INTO users (id, name, alias, passwd, active, access, email, phone, pubphone, googlevoice, sponsor) SELECT id, name, alias, passwd, active, access, email, phone, pubphone, googlevoice, sponsor, FROM %s.users;" % (round,)))
