...
if round:
    ...
    Try:
        print " - users/friends"
        session.execute(text("INSERT INTO users (id, name, alias, passwd, active, access, email, phone, pubphone, _smsmode, sponsor, fleetcount) SELECT id, name, alias, passwd, active, access, email, phone, pubphone, _smsmode::varchar::smsmode, sponsor, 0 FROM %s.users;" % (round,)))
